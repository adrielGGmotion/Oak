...
import com.inspiredandroid.oak.data.EncryptedFileSettings
...
actual fun getAppFilesDirectory(): String {
    ...
    val oakDir = File("$userHome/.oak")
    if (!oakDir.exists()) {
        oakDir.mkdirs()
    }
    return oakDir.absolutePath
}
    ...
    try {
        when (currentPlatform as Platform.Desktop) {
            ...
            Platform.Desktop.Windows -> {
                ...
                val trayIcon = java.awt.TrayIcon(image, "Oak")
