 ...
 *
 * Unlike [com.inspiredandroid.oak.sms.SmsReader] which queries the system content
 * provider, this reads from the in-process [com.inspiredandroid.oak.data.NotificationStore]
