...
import com.inspiredandroid.oak.OAK_BUILD_FILES
import com.inspiredandroid.oak.PlatformBackHandler
...
import com.inspiredandroid.oak.ui.sandbox.SandboxFilesContent
import oak.composeapp.generated.resources.Res
import oak.composeapp.generated.resources.oak_build_exit_content_description
import oak.composeapp.generated.resources.oak_build_new_project_content_description
import oak.composeapp.generated.resources.oak_build_title
...
/**
 * Keeps Oak Build's browser out of the chat sandbox's ViewModel slot: same class,
 * same store owner, so without a distinct key they would share one instance.
 */
private const val KAI_BUILD_FILES_KEY = "oakBuildFiles"

@Immutable
data class OakBuildActions(
...
/**
 * Full-screen Oak Build surface. Entered from the empty chat state and left via
...
fun OakBuildScreen(
    ...
    viewModel: OakBuildViewModel = koinViewModel(),
) {
    ...
    OakBuildScreenContent(state = state, actions = actions, onExit = onExit, modifier = modifier)
}

@Composable
internal fun OakBuildScreenContent(
    state: OakBuildUiState,
    actions: OakBuildActions,
    onExit: () -> Unit,
    modifier: Modifier = Modifier,
) {
    ...
    Surface(
        ...
        Column(
            ...
            if (project != null) {
                ...
                OakBuildTopBar(
                    title = stringResource(Res.string.oak_build_title),
                    onExit = onExit,
                    actions = {
                            ...
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = stringResource(
                                        Res.string.oak_build_new_project_content_description,
                                    ),
                                )
                            }
                        }
    ...
    Row(
        ...
        IconButton(onClick = onExit, modifier = Modifier.handCursor()) {
            Icon(
                ...
                contentDescription = stringResource(Res.string.oak_build_exit_content_description),
            )
        }
        Text(
            text = title,
