...
import com.inspiredandroid.oak.ui.dynamicui.OakUiNode
...
@Immutable
data class OakUiBlock(val node: OakUiNode, val rawJson: String) : BlockNode

@Immutable
data class OakUiError(val rawJson: String) : BlockNode
