package com.inspiredandroid.oak.ui.markdown
...
import com.inspiredandroid.oak.ui.markdown.math.MathFormula
 ...
 *
 * Oak-UI blocks dispatch to [OakUiRenderer]; pass `isInteractive = false` to render them as
...
fun MarkdownContent(
    ...
    val doc = remember(content) {
        runCatching { parseMarkdown(content) }.getOrElse {
            MarkdownDocument(persistentListOf(Paragraph(persistentListOf(com.inspiredandroid.oak.ui.markdown.Text(content)))))
        }
    }
