...
import com.inspiredandroid.oak.build.BuildTerminalSession
import com.inspiredandroid.oak.build.PlatformTerminalKeyboard
import com.inspiredandroid.oak.build.supportsRawTerminalInput
import com.inspiredandroid.oak.build.terminal.MIN_COLUMNS
import com.inspiredandroid.oak.build.terminal.MIN_ROWS
import com.inspiredandroid.oak.build.terminal.TerminalKey
import com.inspiredandroid.oak.build.terminal.TerminalModifiers
import com.inspiredandroid.oak.build.terminal.TerminalMouseEncoder
import com.inspiredandroid.oak.build.terminal.TerminalSnapshot
import com.inspiredandroid.oak.ui.handCursor
import com.inspiredandroid.oak.ui.settings.monoStyle
import oak.composeapp.generated.resources.Res
import oak.composeapp.generated.resources.oak_build_terminal_placeholder
import oak.composeapp.generated.resources.oak_build_terminal_raw_hint
import oak.composeapp.generated.resources.oak_build_terminal_run_content_description
import oak.composeapp.generated.resources.oak_build_terminal_running
import oak.composeapp.generated.resources.oak_build_terminal_show_keyboard_content_description
            ...
            Column {
                ...
                if (!hideInputBar) {
                    Row(
                        ...
                        if (rawInput) {
                            Text(
                                text = stringResource(Res.string.oak_build_terminal_raw_hint),
                            ...
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = stringResource(
                                        Res.string.oak_build_terminal_show_keyboard_content_description,
                                    ),
                                    tint = AnsiPalette[7],
                                )
                            }
                            ...
                            TextField(
                                ...
                                placeholder = {
                                    Text(
                                        text = stringResource(
                                            if (busy) {
                                                Res.string.oak_build_terminal_running
                                            } else {
                                                Res.string.oak_build_terminal_placeholder
                                            },
                                        ),
                        ...
                        if (busy && !rawInput) {
                            IconButton(onClick = submit, modifier = Modifier.handCursor()) {
                                Icon(
                                    ...
                                    contentDescription = stringResource(
                                        Res.string.oak_build_terminal_run_content_description,
                                    ),
                                    tint = AnsiPalette[10],
                                )
                            }
