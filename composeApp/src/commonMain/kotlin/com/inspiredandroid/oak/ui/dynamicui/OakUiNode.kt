...
data class ColumnNode(
    ...
    @Contextual val children: ImmutableList<OakUiNode> = persistentListOf(),
) : OakUiNode
...
data class ListNode(
    override val id: String? = null,
    @Contextual val items: ImmutableList<OakUiNode> = persistentListOf(),
