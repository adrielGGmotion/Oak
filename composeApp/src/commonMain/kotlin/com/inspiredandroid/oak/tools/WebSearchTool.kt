...
import oak.composeapp.generated.resources.tool_web_search_description
import oak.composeapp.generated.resources.tool_web_search_name
    ...
    override suspend fun execute(args: Map<String, Any>): Any {
        ...
        return try {
            ...
            val response = client.get("https://lite.duckduckgo.com/lite/?q=$encoded") {
                header("User-Agent", "Mozilla/5.0 (compatible; Oak/1.0)")
            }
