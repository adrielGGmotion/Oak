...
/** Ordered steps of a Oak Build install, shown as progress on the setup screen. */
...
/** Everything the Oak Build screen renders, in one snapshot. */
@Immutable
data class OakBuildState(
