...
data class SettingsActions(
    ...
    val onChangeSamplerTopK: (String, Int) -> Unit,
    val onChangeSamplerTopP: (String, Float) -> Unit,
    val onChangeSamplerTemperature: (String, Float) -> Unit,
    ...
    companion object {
        val NoOp = SettingsActions(
            ...
            onChangeSamplerTopK = { _, _ -> },
            onChangeSamplerTopP = { _, _ -> },
            onChangeSamplerTemperature = { _, _ -> },
            onExportSettings = { _ -> "" },
