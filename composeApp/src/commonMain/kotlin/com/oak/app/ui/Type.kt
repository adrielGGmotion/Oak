...
fun OakFontFamily.resolve(): FontFamily = when (this) {
    ...
    OakFontFamily.Lora -> FontFamily(Font(resource = Res.font.Lora_Regular, weight = FontWeight.Normal))
    OakFontFamily.Merriweather -> FontFamily(Font(resource = Res.font.Merriweather_Variable, weight = FontWeight.Normal))
    OakFontFamily.Prata -> FontFamily(Font(resource = Res.font.Prata_Regular, weight = FontWeight.Normal))
    OakFontFamily.JetBrainsMono -> FontFamily(Font(resource = Res.font.JetBrainsMono_Variable, weight = FontWeight.Normal))
}
