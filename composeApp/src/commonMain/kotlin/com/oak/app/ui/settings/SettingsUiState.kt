...
data class SettingsUiState(
    ...
    val isUnlimitedToolCallsEnabled: Boolean = false,
    ...
    val samplerTopK: ImmutableMap<String, Int> = persistentMapOf(),
    val samplerTopP: ImmutableMap<String, Float> = persistentMapOf(),
    val samplerTemperature: ImmutableMap<String, Float> = persistentMapOf(),
