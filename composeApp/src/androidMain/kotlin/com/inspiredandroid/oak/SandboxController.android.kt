...
import com.inspiredandroid.oak.sandbox.SessionShell
import com.inspiredandroid.oak.sandbox.importFileInto
import com.inspiredandroid.oak.sandbox.openFileWithIntent
import com.inspiredandroid.oak.sandbox.readFileAsText
import com.inspiredandroid.oak.sandbox.resolveSandboxAbsolute
import com.inspiredandroid.oak.sandbox.toFileEntry
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.inspiredandroid.oak.TerminalLine> = sandboxManager.transcriptFor(sessionId)
