...
import com.inspiredandroid.oak.shared.R
 ...
 */
const val EXTRA_OPEN_HEARTBEAT = "com.inspiredandroid.oak.OPEN_HEARTBEAT"

/** Shared with the AI `send_notification` tool — ensures the channel is created once. */
private const val CHANNEL_ID = "oak_ai_notifications"
