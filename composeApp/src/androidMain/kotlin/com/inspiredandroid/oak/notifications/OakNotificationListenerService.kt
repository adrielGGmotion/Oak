package com.inspiredandroid.oak.notifications
...
import com.inspiredandroid.oak.data.NotificationSyncState
 ...
 * - Hard-blocked package (Oak itself, system UI) → drop, avoids feedback loops.
...
class OakNotificationListenerService : NotificationListenerService() {
