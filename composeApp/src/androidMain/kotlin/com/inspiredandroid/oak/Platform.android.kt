...
import com.inspiredandroid.oak.notifications.declaresNotificationListener
import com.inspiredandroid.oak.sandbox.LinuxSandboxManager
import com.inspiredandroid.oak.sandbox.SandboxState
import com.inspiredandroid.oak.sms.SmsReader
import com.inspiredandroid.oak.sms.SmsSender
import com.inspiredandroid.oak.sms.declaresReadSms
import com.inspiredandroid.oak.tools.AppPermission
import com.inspiredandroid.oak.tools.CalendarRepository
import com.inspiredandroid.oak.tools.CalendarResult
import com.inspiredandroid.oak.tools.CommonTools
import com.inspiredandroid.oak.tools.EmailTools
import com.inspiredandroid.oak.tools.FetchUrlTool
import com.inspiredandroid.oak.tools.HeartbeatTools
import com.inspiredandroid.oak.tools.NotificationHelper
import com.inspiredandroid.oak.tools.NotificationResult
import com.inspiredandroid.oak.tools.NotificationTools
import com.inspiredandroid.oak.tools.OpenFileTool
import com.inspiredandroid.oak.tools.PermissionController
import com.inspiredandroid.oak.tools.ProcessManagerTool
import com.inspiredandroid.oak.tools.SchedulingTools
import com.inspiredandroid.oak.tools.ShellCommandTool
import com.inspiredandroid.oak.tools.SmsTools
import com.inspiredandroid.oak.tools.SshConfigureHostTool
import com.inspiredandroid.oak.tools.WebSearchTool
...
import oak.composeapp.generated.resources.tool_open_file_description
import oak.composeapp.generated.resources.tool_open_file_name
import oak.composeapp.generated.resources.tool_send_notification_description
...
actual fun createSecureSettings(): Settings {
    ...
    return try {
        ...
        context.deleteSharedPreferences("oak_secure_prefs")
        SharedPreferencesSettings(createEncryptedPrefs(context))
    }
}
...
actual fun createLegacySettings(): Settings? {
    val context: Context by inject(Context::class.java)
    val prefs = context.getSharedPreferences("com.inspiredandroid.oak_preferences", Context.MODE_PRIVATE)
            ...
            add(
                object : Tool {
                    ...
                    override suspend fun execute(args: Map<String, Any>): Any {
                        val title = args["title"] as? String ?: "Oak 9000"
