package com.inspiredandroid.oak.testutil

import com.inspiredandroid.oak.data.Conversation
import com.inspiredandroid.oak.data.DataRepository
import com.inspiredandroid.oak.data.EmailAccount
import com.inspiredandroid.oak.data.EmailSyncState
import com.inspiredandroid.oak.data.FallbackStatus
import com.inspiredandroid.oak.data.FreeMode
import com.inspiredandroid.oak.data.HeartbeatConfig
import com.inspiredandroid.oak.data.HeartbeatLogEntry
import com.inspiredandroid.oak.data.ImportSection
import com.inspiredandroid.oak.data.MemoryEntry
import com.inspiredandroid.oak.data.ScheduledTask
import com.inspiredandroid.oak.data.Service
import com.inspiredandroid.oak.data.ServiceEntry
import com.inspiredandroid.oak.data.ServiceInstance
import com.inspiredandroid.oak.data.SmsDraft
import com.inspiredandroid.oak.data.SmsSyncState
import com.inspiredandroid.oak.data.SystemPromptVariant
import com.inspiredandroid.oak.data.ThemeMode
import com.inspiredandroid.oak.data.ensureSelectedModelPresent
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(
        ...
        uiSubmission: com.inspiredandroid.oak.data.UiSubmission?,
    ...
    var skills: List<com.inspiredandroid.oak.skills.SkillManifest> = emptyList()

    override fun getInstalledSkills(): List<com.inspiredandroid.oak.skills.SkillManifest> = skills
    override suspend fun uninstallSkill(id: String) {}
    override suspend fun browseSkillMarketplaces(): Result<List<com.inspiredandroid.oak.skills.RegistrySkillEntry>> = Result.success(emptyList())
    override suspend fun installBrowsedSkill(entry: com.inspiredandroid.oak.skills.RegistrySkillEntry): Result<com.inspiredandroid.oak.skills.SkillManifest> = Result.failure(NotImplementedError())
    override suspend fun installGitHubSkill(owner: String, repo: String, ref: String, path: String): Result<com.inspiredandroid.oak.skills.SkillManifest> = Result.failure(NotImplementedError())
    ...
    override fun getNotificationSyncState(): com.inspiredandroid.oak.data.NotificationSyncState = com.inspiredandroid.oak.data.NotificationSyncState()
