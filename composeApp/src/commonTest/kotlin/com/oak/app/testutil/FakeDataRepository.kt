...
import com.oak.app.data.ServiceInstance
import com.oak.app.data.SmsDraft
import com.oak.app.data.SmsSyncState
import com.oak.app.data.SystemPromptVariant
...
class FakeDataRepository : DataRepository {
    ...
    private var storageAccessEnabled = false

    override fun isStorageAccessEnabled(): Boolean = storageAccessEnabled
    ...
    override fun getNotificationSyncState(): com.oak.app.data.NotificationSyncState = com.oak.app.data.NotificationSyncState()
